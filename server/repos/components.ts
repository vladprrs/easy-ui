...
export class ComponentRepo {
  ...
  /**
   * Плоские receipt-ссылки acceptance (A9) отдаются вместе со статусом версии: `acceptanceRunId`
   * непуст ⟺ версия опубликована promote'ом с терминальным (pass) раном — это и есть источник
  ...
  // A9-receipts (`candidateId`/`acceptanceRunId`) отдаются и здесь — план 2026-08-04 W3: без них
  // одиночный DTO версии был единственным местом, где связка с приёмкой пропадала. Ограничение
