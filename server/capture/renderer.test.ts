...
describe("renderer fingerprint 2.0", () => {
  ...
  test("bump алгоритма отпечатка случая: версия === 7", () => {
    ...
    // кадр/сравнение/вердикт. Версия 7 — третьему (2026-08-05, §A4): в кадр случая могут входить
    // запинованные опубликованные дети слотов, и вердикты, снятые без знания о них, санкционированно
    // инвалидируются.
