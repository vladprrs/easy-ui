...
export async function routeVisualBaselines(request:Request,db:Database,dataDir:string,segments:string[]):Promise<Response|null> {
  ...
  if(request.method==="GET") return json(repo.get(id),200,noStore);
