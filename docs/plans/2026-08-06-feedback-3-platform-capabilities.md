...
После v4 blocking-возражений по §W4/§W5 не осталось; волны W4/W5 стартуют по v4 без дополнительного раунда (исполнителям сверять номера строк по содержанию — код уже сдвинут волнами W1/W6/W2).
