...
- Production-деплой в Dokploy описан в `docs/server-api.md#deployment`; точка входа — корневой `docker-compose.yml`, секрет `BASIC_AUTH` задаётся в окружении Dokploy.
