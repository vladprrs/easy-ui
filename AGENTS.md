...
- Публичный API имеет rate-limit на логин: не логиниться в цикле; auth-клиент драйвера
  кэширует сессию на диске между вызовами (выключатель `EASYUI_SESSION_CACHE=0`).
