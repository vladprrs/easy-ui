...
export const share = {
  ...
  // Список версий грузится внутри этого же окна (план W6 §2): раньше загрузка жила
  // в отдельной узкой панели, которая затем подменялась широким диалогом — окно
  // прыгало на глазах. Корпус теперь один, меняется только его содержимое.
  versionsLoading: "Загружаем версии…",
  versionsLoadFailed: "Не удалось загрузить версии для ссылки.",
  versionsEmpty: "Опубликованных версий для ссылки нет.",
  versionsEmptyHint: "Ссылка ведёт на опубликованную версию — черновик по ней не откроется.",
  versionsPublishCta: "Опубликовать версию",
