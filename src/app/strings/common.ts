...
// Allowlist доменных терминов без перевода: API, Basic Auth. Аббревиатура «CJM»
// из видимых подписей выведена (план 2026-07-31, S1) и осталась только в коде,
// именах файлов и маршруте `/p/:id/cjm`.
...
export const appShell = {
  /** Логотип «Пэй» рисуется вордмарком, текстом остаётся только продуктовая часть. */
  brandSuffix: "Прототипы",
  loading: "Загрузка…",
  logout: "Выйти",
...
export const prototypeChrome = {
  ...
  player: "Плеер",
  /**
   * Ключ остаётся `cjm` — это id вью и маршрут `/p/:id/cjm`; пользователю же
   * аббревиатура не показывается (план 2026-07-31, S1): сегмент хрома называет
   * *место* разбора, а режим внутри него («Сценарии/Дорожки») живёт в канве.
   */
  cjm: "Сценарии",
  editor: "Редактор",
  draftBadge: "черновик",
