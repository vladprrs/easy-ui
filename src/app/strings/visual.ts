...
export const visual = {
  ...
  // Окно бренда вместо window.confirm (S6): удаление эталона необратимо, и текст
  // обязан назвать последствие, а не просто переспросить.
  deleteDialogTitle: "Удалить эталон?",
  deleteDialogBody: "Эталонный снимок будет удалён без возможности восстановления — проверки по нему перестанут проходить, пока не снимут новый. История прогонов сохранится.",
  deleteConfirmAction: "Удалить эталон",
