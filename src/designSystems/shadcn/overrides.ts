export const shadcnFixtureOverrides: Record<string, Record<string, unknown>> = {
  ...
  Spinner: { size: "md", label: "Loading" }, Tooltip: { content: "Helpful context", text: "Hover for help" },
