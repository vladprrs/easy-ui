...
export function CjmView({ doc, custom, runtimeKey, routeBase }: { doc: PrototypeDoc; custom?: CustomPlayerRuntime; runtimeKey: string; routeBase: string }) {
  ...
  return <main className="min-h-screen bg-muted/30 p-6 sm:p-8">
    <header className="mx-auto flex max-w-[1600px] items-start justify-between gap-6">
      ...
      <Link className="shrink-0 rounded-md border bg-background px-4 py-2 font-medium hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" to={routeBase}>Открыть плеер</Link>
    </header>
