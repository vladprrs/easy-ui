...
export function CjmShell() {
  ...
  return <PrototypeLoader protoId={protoId} version={numericVersion}>
    {({ loaded, custom, runtimeKey, routeBase }) => <CjmView doc={loaded.doc} custom={custom} runtimeKey={runtimeKey} routeBase={routeBase} version={numericVersion} designSystemMetaVersion={loaded.designSystemMetaVersion} />}
  </PrototypeLoader>;
}
