...
import { chip, chipActive, inputBase, pillGhost, pillGhostOnDark, pillPrimary } from "../app/chrome";
...
function ShareDialog({ prototypeId, versions, currentVersion, onClose }: {
  prototypeId: string;
